  ...
  return (
    <div className="pb-16">
      ...
      <div className="flex flex-col justify-center items-center gap-4 mt-10 max-w-sm mx-auto">
        ...
        <p className="text-center md:text-lg text-white/60 ">
        ...
        {projectsData.map((project, index) => (
          ...
          >
            ...
            <div className="flex flex-col">
              ...
              <h1 className="font-serif text-2xl mt-2 md:text-4xl md:mt-5 ">{project.title}</h1>
              ...
              <button className="bg-white mt-8 text-gray-950 h-12 w-full md:w-auto px-4 rounded-xl font-semibold ">
                <Link
                  href={project.link}
