    ...
    >
      ...
      <div className="absolute inset-0 masked-div">
        ...
        <HeroOrbit size={800} rotation={-72}>
          <StarIcon className="size-28 text-indigo-400/80" />
        </HeroOrbit>
        <HeroOrbit size={610} rotation={-120}>
          <StarIcon className="size-20 text-indigo-300/70" />
        </HeroOrbit>
        <HeroOrbit size={750} rotation={70}>
          <StarIcon className="size-16 text-indigo-300/70" />
        </HeroOrbit>
        <HeroOrbit size={450} rotation={160}>
          <StarIcon className="size-10 text-indigo-300/50" />
        </HeroOrbit>
        <HeroOrbit size={550} rotation={20}>
          <StarIcon className="size-12 text-indigo-300/80" />
        </HeroOrbit>
        <HeroOrbit size={590} rotation={98}>
          <StarIcon className="size-8 text-indigo-300/80" />
        </HeroOrbit>
        <HeroOrbit size={430} rotation={-14}>
          <SparkleIcon className="size-8 text-indigo-300/20" />
        </HeroOrbit>
        <HeroOrbit size={440} rotation={79}>
          <SparkleIcon className="size-5 text-indigo-300/20" />
        </HeroOrbit>
        <HeroOrbit size={530} rotation={178}>
          <SparkleIcon className="size-10 text-indigo-300/20" />
        </HeroOrbit>
        <HeroOrbit size={710} rotation={144}>
          <SparkleIcon className="size-14 text-indigo-300/20" />
        </HeroOrbit>
        <HeroOrbit size={720} rotation={0}>
          <div className="size-3 rounded-full bg-indigo-300/20" />
        </HeroOrbit>
        <HeroOrbit size={520} rotation={-41}>
          <div className="size-2 rounded-full bg-indigo-300/20" />
        </HeroOrbit>
